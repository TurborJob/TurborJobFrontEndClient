...
export default function Register() {
  ...
  const handleRegister = async () => {
    ...
    if (!ip) {
      toast(
        getToast(
          "error",
          titleI18n["ip_address_is_require"],
          titleI18n["error"]
        )
      );
      setIsLoading(false);
  ...
  return (
    ...
    >
      <Stack spacing={8} mx={"auto"} maxW={"xxl"} py={12} px={2}>
        <Stack align={"center"}>
        ...
        >
          <Stack spacing={4}>
            <Form form={form} layout={"vertical"}>
              ...
              <Box>
                <Form.Item
                  label={titleI18n["username"]}
                  name="username"
                  rules={[
                    {
                      required: true,
                      message: titleI18n["please_enter_username"],
                    },
                    {
                      pattern: new RegExp(/^[a-zA-Z0-9_-]{6,20}$/),
                      message:
                        titleI18n[
                          "username_must_be_between_6_and_20_characters"
                        ],
                    },
                  ]}
                  hasFeedback
              ...
              <Grid templateColumns="repeat(2, 1fr)" gap={2}>
                <Box>
                  <Form.Item
                    label={titleI18n["password"]}
                    name="password"
                    rules={[
                      {
                        required: true,
                        message: titleI18n["password_is_require"],
                      },
                      {
                        pattern: new RegExp(
                          /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^\da-zA-Z]).{8,}$/
                      ...
                      ({ getFieldValue }) => ({
                        validator(_, value) {
                          ...
                          return Promise.reject(
                            new Error(
                              titleI18n["confirm_password_do_not_match"]
                            )
                          );
                        },
                      }),
              ...
              <Grid templateColumns="repeat(2, 1fr)" gap={2}>
                <Box>
                  <Form.Item
                    label={titleI18n["first_name"]}
                    name="firstName"
                    rules={[
                      {
                        required: true,
                        message: titleI18n["first_name_is_require"],
                      },
                    ]}
                  >
                    <Input />
                ...
                <Box>
                  <Form.Item
                    label={titleI18n["last_name"]}
                    name="lastName"
                    rules={[
                      {
                        required: true,
                        message: titleI18n["last_name_is_require"],
                      },
                    ]}
                  >
                    <Input />
                ...
                <Box>
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: titleI18n["email_is_require"],
                      },
                      {
                        type: "email",
                ...
                <Box>
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: titleI18n["phone_is_require"],
                      },
                      {
                        pattern: new RegExp(
              ...
              <Form.Item
                ...
                name="address"
                rules={[
                  { required: true, message: titleI18n["address_is_require"] },
                ]}
              >
                <Input />
              </Form.Item>
                ...
                <Box>
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: titleI18n["birthday_is_require"],
                      },
                    ]}
                    format={"dd/MM/yyyy"}
                  >
            ...
            <UnorderedList style={{ fontSize: "small", fontWeight: "lighter" }}>
              <ListItem>
                {titleI18n["username_must_have_a_length_of_6_to_20_characters"]}
              </ListItem>
              <ListItem>
                {
                  titleI18n[
                    "password_must_contain_uppercase_letters_lowercase_letters_numbers_special_characters_and_be_at_least_8_characters_long"
                  ]
                }
              </ListItem>
              <ListItem>
                {
                  titleI18n[
                    "phone_numbers_for_vietnamese_carriers_must_be_either_10_or_11_digits_long"
                  ]
                }
              </ListItem>
            </UnorderedList>
